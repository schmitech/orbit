...
<p align="center">
  ...
  <a href="https://github.com/schmitech/orbit/releases"><img src="https://img.shields.io/badge/version-2.9.0-blue" alt="Version"></a>
</p>
...
```bash
curl -LO https://github.com/schmitech/orbit/releases/download/v2.9.0/orbit-2.9.0.tar.gz
tar -xzf orbit-2.9.0.tar.gz && cd orbit-2.9.0
