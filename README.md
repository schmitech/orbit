...
<p align="center">
  ...
  <a href="https://github.com/schmitech/orbit/releases"><img src="https://img.shields.io/badge/version-2.15.8-blue" alt="Version 2.15.8" /></a>
...
```bash
curl -L https://github.com/schmitech/orbit/releases/download/v2.15.8/orbit-2.15.8.tar.gz -o orbit-2.15.8.tar.gz
tar -xzf orbit-2.15.8.tar.gz
cd orbit-2.15.8
