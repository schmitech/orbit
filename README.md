...
<p align="center">
  ...
  <a href="https://github.com/schmitech/orbit/releases"><img src="https://img.shields.io/badge/version-2.16.0-blue" alt="Version 2.16.0" /></a>
...
```bash
curl -L https://github.com/schmitech/orbit/releases/download/v2.16.0/orbit-2.16.0.tar.gz -o orbit-2.16.0.tar.gz
tar -xzf orbit-2.16.0.tar.gz
cd orbit-2.16.0
