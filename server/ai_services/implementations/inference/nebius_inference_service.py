"""
Nebius AI Studio inference service implementation.

Nebius provides European-based GPU cloud inference for open-source models
via an OpenAI-compatible API at https://api.studio.nebius.ai/v1.
