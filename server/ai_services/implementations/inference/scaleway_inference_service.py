"""
Scaleway inference service implementation.

Scaleway Generative APIs provides European sovereign cloud inference for open-source
...
class ScalewayInferenceService(InferenceService, OpenAICompatibleBaseService):
