"""
Cerebras inference service implementation.

Cerebras provides ultra-fast inference via an OpenAI-compatible API at
https://api.cerebras.ai/v1. Known for very low latency on supported models.
"""
...
class CerebrasInferenceService(InferenceService, OpenAICompatibleBaseService):
    ...
    def __init__(self, config: Dict[str, Any]):
        InferenceService.__init__(self, config, "cerebras")
