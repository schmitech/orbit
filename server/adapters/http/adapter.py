...
class HttpAdapter(DocumentAdapter):
    ...
    for natural language to HTTP request translation.
    """
    ...
    def __init__(self,
        ...
        Args:
            ...
            template_library_path: Path(s) to HTTP template library YAML file(s)
    ...
    def _load_yaml_config(self, path: str, config_type: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if not os.path.isabs(path):
                # From server/adapters/http/adapter.py go up to project root
    ...
    def format_document(self, raw_doc: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            raw_doc: The raw document text (HTTP response as string)
