"""
Embedding Cache Manager for managing embedding service instances.
...
class EmbeddingCacheManager:
    ...
    - Handle embedding service creation
    ...
    def build_cache_key(self, provider_name: str) -> str:
        """
        Build cache key for an embedding service.
    ...
    async def create_service(
        ...
        """
        Create and cache a new embedding service instance.
