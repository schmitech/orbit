...
| **AC-7 Unsuccessful Logon Attempts** | **Rate Limiting & Lockout Roadmap**: Inbound authentication endpoints enforce connection rate limits. | Supports brute-force connection throttling. | **Roadmap Note (Phases 1-3)**: Implementation plans detail upcoming dedicated login rate limiting per IP/user ([Phase 1 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-1-auth-login-rate-limiting.md)), password complexity policies ([Phase 2 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-2-auth-password-complexity.md)), and automatic account lockout after consecutive failed attempts ([Phase 3 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-3-auth-account-lockout.md)). |
...
- **Login Rate Limiting (Phase 1)**: Dedicated rate limiting per IP address and target account for local authentication routes to mitigate brute-force password discovery ([Phase 1 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-1-auth-login-rate-limiting.md)).
- **Password Complexity Policies (Phase 2)**: Configurable password strength criteria (minimum length, uppercase, lowercase, numeric, and special character rules) for local user account creation ([Phase 2 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-2-auth-password-complexity.md)).
...
- **Expanded Audit Trail Coverage (Phase 4)**: Extended audit event logging covering password modifications, failed login attempts, rate-limit/lockout events, and session revocation ([Phase 4 Roadmap](https://github.com/schmitech/orbit/blob/main/docs/roadmap/authentication/phase-4-auth-audit-trail-coverage.md)).
