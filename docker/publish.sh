...
#                  If --tag is 2.16.0-openai, the source release resolves to
#                  v2.16.0 unless --release-tag is provided.
...
#     schmitech/orbit:2.16.0-gemini
#     schmitech/orbit:2.16.0-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.16.0"
    echo "  ./publish.sh --build --tag 2.16.0-openai --release-tag v2.16.0 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.16.0"
