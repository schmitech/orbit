...
#                  If --tag is 2.15.2-openai, the source release resolves to
#                  v2.15.2 unless --release-tag is provided.
...
#     schmitech/orbit:2.15.2-gemini
#     schmitech/orbit:2.15.2-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.15.2"
    echo "  ./publish.sh --build --tag 2.15.2-openai --release-tag v2.15.2 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.15.2"
