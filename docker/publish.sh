...
#                  If --tag is 2.15.8-openai, the source release resolves to
#                  v2.15.8 unless --release-tag is provided.
...
#     schmitech/orbit:2.15.8-gemini
#     schmitech/orbit:2.15.8-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.15.8"
    echo "  ./publish.sh --build --tag 2.15.8-openai --release-tag v2.15.8 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.15.8"
