...
#                  If --tag is 2.15.7-openai, the source release resolves to
#                  v2.15.7 unless --release-tag is provided.
...
#     schmitech/orbit:2.15.7-gemini
#     schmitech/orbit:2.15.7-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.15.7"
    echo "  ./publish.sh --build --tag 2.15.7-openai --release-tag v2.15.7 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.15.7"
