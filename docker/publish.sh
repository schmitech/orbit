...
#                  If --tag is 2.17.14-openai, the source release resolves to
#                  v2.17.14 unless --release-tag is provided.
...
#     schmitech/orbit:2.17.14-gemini
#     schmitech/orbit:2.17.14-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.17.14"
    echo "  ./publish.sh --build --tag 2.17.14-openai --release-tag v2.17.14 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.17.14"
