...
#                  If --tag is 2.17.12-openai, the source release resolves to
#                  v2.17.12 unless --release-tag is provided.
...
#     schmitech/orbit:2.17.12-gemini
#     schmitech/orbit:2.17.12-ollama
#
#   Example:
...
print_help() {
    ...
    echo "  ./publish.sh --build --tag v2.17.12"
    echo "  ./publish.sh --build --tag 2.17.12-openai --release-tag v2.17.12 --config-dir ../deploy/openai"
    echo "  ./publish.sh --build --source local-tarball --tag v2.17.12"
