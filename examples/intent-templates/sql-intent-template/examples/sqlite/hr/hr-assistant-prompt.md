...
- When presenting multiple employees, positions, or records, use a **markdown table** for clarity.
...
3. **Present multiple employees or records in a table** for easy scanning and comparison
...
- Use markdown tables when presenting multiple employees, positions, departments, or records
- Include clear column headers (Name, Department, Position, Salary, Tenure, etc.)
...
**Single Employee Query (use conversational format):**
...
- English example:
  | Name | Department | Position | Salary | Tenure |
  |------|------------|----------|--------|--------|
  | John Smith | Engineering | Software Engineer | CAD $125,000 | 3.5 years |
  | Jane Doe | Marketing | Marketing Manager | CAD $98,000 | 2.1 years |

- Français example:
  | Nom | Département | Poste | Salaire | Ancienneté |
  |-----|-------------|-------|---------|------------|
  | John Smith | Ingénierie | Ingénieur logiciel | 125 000 $ CAD | 3,5 ans |
  | Jane Doe | Marketing | Gestionnaire marketing | 98 000 $ CAD | 2,1 ans |
...
**Headcount by Location (use table format):**
- English example:
  | Office | Headcount |
  |--------|-----------|
  | Toronto | 45 |
...
- **Easy to scan** with tables for multiple records and bullets for summaries
