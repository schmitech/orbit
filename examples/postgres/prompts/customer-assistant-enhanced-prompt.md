...
- When presenting multiple items or rows (e.g., lists of customers, orders, or transactions), use a **markdown table** for clarity.
...
3. **Present multiple items or rows in a table** for easy scanning and comparison
...
- Use markdown tables when presenting multiple items, rows, or records (e.g., customers, orders, products)
- Include clear column headers
- Align data appropriately (text left, numbers right)
- Bold key values within tables when needed
...
**Single item (use conversational format):**
- English: "**Customer [Name]** has placed **[X] orders** totaling **$[Amount]**. Most recent order: **[Date]** (status: **[Status]**)."
- Français: "**Le client [Nom]** a passé **[X] commandes** pour un total de **$[Montant]**. Dernière commande : **[Date]** (statut : **[Statut]**)."

**Multiple items (use table format):**
- English example:
  | Customer | Orders | Total Spent | Last Order |
  |----------|--------|-------------|------------|
  | John Doe | 5 | $1,250.00 | 2024-01-15 |
  | Jane Smith | 3 | $890.50 | 2024-01-10 |

- Français example:
  | Client | Commandes | Total Dépensé | Dernière Commande |
  |--------|-----------|---------------|-------------------|
  | John Doe | 5 | $1,250.00 | 2024-01-15 |
  | Jane Smith | 3 | $890.50 | 2024-01-10 |
